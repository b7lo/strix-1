...
export const THRESHOLDS = {
  ...
  // ═══════════════════════════════════════════════════════════════
  // Phase 3 — Impact State Machine
  // القيم الزمنية مستقلة عن معدل العينات، وتُراجع منفصلة عن بنية الآلة.
  // ═══════════════════════════════════════════════════════════════
  /** أقل مدة نبضة معتدلة قبل التأكيد؛ الضربة القوية تُؤكد فوراً. */
  IMPACT_CANDIDATE_MIN_DURATION_MS: 10,
  /** النبضة المستمرة أطول من ذلك حركة/اهتزاز وليست اصطداماً لحظياً. */
  IMPACT_CANDIDATE_MAX_DURATION_MS: 300,
  /** مضاعف العتبة لتأكيد ضربة قوية من عينة واحدة. */
  IMPACT_INSTANT_CONFIRM_MULTIPLIER: 2,
  /** نافذة ضم الصدمات الثانوية للحادث نفسه. */
  IMPACT_POST_WINDOW_MS: 2500,
  /** منع فتح حادث جديد مباشرة بعد اكتمال نافذة الحادث. */
  IMPACT_COOLDOWN_MS: 8000,
  /** أقل قوة نسبية لتسجيل صدمة ثانوية داخل الحادث. */
  IMPACT_SECONDARY_MULTIPLIER: 0.75,
  /** أدنى جودة تسمح بقرار تأكيد. */
  IMPACT_MIN_QUALITY_SCORE: 25,
