          ...
          <div className="footer-links">
            <div className="footer-link-group">
              ...
              <ul>
                ...
                <li><a href="#showcase">التطبيق</a></li>
            ...
            <div className="footer-link-group">
              <h4>تواصل</h4>
              <ul>
                <li><a href="mailto:support@strixsa.com">للأفراد: support@strixsa.com</a></li>
                <li><a href="mailto:business@strixsa.com">للأعمال: business@strixsa.com</a></li>
