    ...
    <section className="form-section" id="join">
      ...
      <div className="form-card reveal">
        ...
        <div className="form-info">
          ...
          <h3 className="form-info-title">احمِ حقك بالبيانات</h3>
          <p className="form-info-sub">
            ولأن الحقيقة تبدأ بالبيانات، انضم إلى قائمة الانتظار الحصرية واحصل على وصول مبكر لتطبيق ستركس قبل الإطلاق الرسمي.
          </p>
